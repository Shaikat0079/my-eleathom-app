...
const Mentorship = () => {
  return (
    <div className="mentorship">{/* <= added this class */}
      ...
      <div className="boxes">
        <div className="box">
          ...
          <p>Learn how to build and maintain a professional brand that sets you apart in the legal field.</p>
        </div>

        <div className="box">
          <div className="icon"><IoDocumentTextOutline /></div>
          <h3>Technical Writing</h3>
          <p>Develop essential legal writing and research skills through practical assessments and feedback.</p>
        </div>

        <div className="box">
          <div className="icon"><FiZap /></div>
          <h3>Career Success</h3>
          <p>Gain insights into what it takes to be a successful legal practitioner in today's competitive market.</p>
        </div>
      </div>

      <h1 className="mentor-Big">EleaThom Mentorship 2025 Assistants & Alumni</h1>
